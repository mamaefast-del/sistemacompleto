-- =====================================================
-- ADICIONAR TABELAS DO SISTEMA DE AFILIADOS
-- Para ser executado no banco caixasupresa existente
-- =====================================================
...
CREATE TABLE IF NOT EXISTS `affiliate_clicks` (
    ...
    CONSTRAINT `fk_affiliate_clicks_affiliate` FOREIGN KEY (`affiliate_id`) REFERENCES `usuarios`(`id`) ON DELETE SET NULL,
    CONSTRAINT `fk_affiliate_clicks_user` FOREIGN KEY (`usuario_convertido_id`) REFERENCES `usuarios`(`id`) ON DELETE SET NULL
...
CREATE TABLE IF NOT EXISTS `affiliate_attributions` (
    ...
    CONSTRAINT `fk_affiliate_attributions_user` FOREIGN KEY (`user_id`) REFERENCES `usuarios`(`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_affiliate_attributions_affiliate` FOREIGN KEY (`affiliate_id`) REFERENCES `usuarios`(`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_affiliate_attributions_click` FOREIGN KEY (`click_id`) REFERENCES `affiliate_clicks`(`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `payment_callbacks` (
    ...
    CONSTRAINT `fk_payment_callbacks_user` FOREIGN KEY (`user_id`) REFERENCES `usuarios`(`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `historico_afiliados` (
    ...
    CONSTRAINT `fk_historico_afiliados_user` FOREIGN KEY (`afiliado_id`) REFERENCES `usuarios`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- =====================================================
-- 11. ADICIONAR COLUNAS EM TABELAS EXISTENTES
-- =====================================================
...
-- Verificar e adicionar colunas na tabela transacoes_pix
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
...
-- Verificar e adicionar colunas na tabela comissoes (se existir)
SET @sql = (SELECT IF(
...
-- =====================================================
-- 16. DADOS DE EXEMPLO PARA TESTE
-- =====================================================

-- Usuário afiliado de exemplo (se não existir)
...
-- Usuário indicado de exemplo (se não existir)
...
-- RESULTADO FINAL
-- =====================================================
SELECT 'Sistema de Afiliados adicionado com sucesso ao banco existente!' as resultado;
SELECT 'Tabelas criadas: affiliate_clicks, affiliate_attributions, payment_callbacks, affiliate_config' as tabelas_criadas;
SELECT 'Colunas adicionadas em: usuarios, transacoes_pix, comissoes' as colunas_adicionadas;
